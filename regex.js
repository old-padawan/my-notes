...
/*
  ...
  \b - межа слова, наприклад, слово з трьох літер /\b\w\w\w\b/
  \B - все, крім меж слів (між літерами)

  Квантифікація
  /\b\w{3}\b/ - вказуємо, скільки разів має повторитися буква (або щось інше)

  Угруповання
  (\s|-) можлива пробіл або дефіс
  [\s-] аналог
